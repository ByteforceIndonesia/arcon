...
<div class="input-group">
    ...
    <img src="<?php echo base_url() . $config[0]->value_one; ?>" width="20px" height="100px" class="form-control">
</div>
...
<div class="input-group">
    ...
    <img src="<?php echo base_url() . $config[2]->value_one; ?>" width="20px" height="100px" class="form-control">
</div>
...
<div class="input-group">
    ...
    <img src="<?php echo base_url() . $config[3]->value_one; ?>" width="20px" height="100px" class="form-control">
</div>
