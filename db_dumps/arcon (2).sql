...
--
-- Host: localhost
-- Generation Time: Jan 29, 2017 at 05:38 PM
...
INSERT INTO `gallery` (`id`, `project_uuid`, `name`, `images`, `details`, `freatured`) VALUES
(1, 'asdawdasd', 'Apel', 'assets/images/apel/freatured', 'comercial', 1);
...
INSERT INTO `projects` (`id`, `project_uuid`, `description`, `datas`) VALUES
(1, 'asdawdasd', 'asjnd jklads blajkshdbasjhdnbajhsd', 'assets/images/apel');
